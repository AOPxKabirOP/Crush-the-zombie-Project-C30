...
function setup() {
  ...
  zombie.addAnimation("killed", zombie3)
  zombie.scale = 0.1;
  zombie.velocityX = 10;
...
function draw() {
  ...
  if (zombie.position.x >= width - 300 && !cutButtonPressed) {
    zombie.velocityX = -10;
    zombie.changeAnimation("righttoleft");
  }

  if (zombie.position.x <= 300 && !cutButtonPressed) {
    zombie.velocityX = 10;
